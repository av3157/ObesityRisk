...
```
This bar plot, faceted by grade, shows us the health ratings based on specific lifestyle choices. Similar to the plots above, this one follows most of the trends aforementioned. What this signifies is that there is some correlation between strata. 
